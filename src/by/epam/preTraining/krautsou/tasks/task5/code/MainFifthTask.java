...
public class MainFifthTask {
    ...
    public static void main(String[] args) {
        ...
        showRoom[1].addCar(showRoom[1], creator.createElectra("Nissan", "Juke", 750, 175, 3, String.valueOf(Type.CROSSOVER), true, 57, 500,600, 700));
        showRoom[1].addCar(showRoom[1], creator.createOil("Nissan", "JukeEI", 850, 187, 5, String.valueOf(Type.CROSSOVER), true, 60));
        showRoom[2] = new ShowRoom("Infinity");
        showRoom[2].addCar(showRoom[2], creator.createElectra("Infinity", "QEI50", 1150, 235, 4, String.valueOf(Type.SEDAN), true, 75, 850,750, 400));
